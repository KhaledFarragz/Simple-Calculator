...
# 13 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/../mcal_std_libraries.h"
...
Std_ReturnType lcd_8bit_send_string(const chr_lcd_8bit_t *lcd, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
     uint8 l_pin_counter = 0, l_char_counter = 0;
     if(((void*)0) == lcd)
     {
        ret = (Std_ReturnType)0x00 ;
     }
...
static Std_ReturnType lcd_8bits_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 colomn){
    ...
    else
    {
        ...
        switch(row)
        {
            case 0x01 : ret = lcd_8bit_send_command(lcd, (0x80) + colomn);break;
            case 0x02 : ret = lcd_8bit_send_command(lcd, (0xC0) + colomn);break;
            case 0x03 : ret = lcd_8bit_send_command(lcd, (0x94) + colomn);break;
            case 0x04 : ret = lcd_8bit_send_command(lcd, (0xD4) + colomn);break;
            default : ;
        }
    }
    return ret;
...
static Std_ReturnType lcd_4bits_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 colomn){
    ...
    else
    {
        ...
        switch(row)
        {
            case 0x01 : ret = lcd_4bit_send_command(lcd, (0x80) + colomn);break;
            case 0x02 : ret = lcd_4bit_send_command(lcd, (0xC0) + colomn);break;
            case 0x03 : ret = lcd_4bit_send_command(lcd, (0x94) + colomn);break;
            case 0x04 : ret = lcd_4bit_send_command(lcd, (0xD4) + colomn);break;
            default : ;
        }
    }
    return ret;
}
# 463 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
void clearDataArrays(uint8 arr[], uint8 size) {
