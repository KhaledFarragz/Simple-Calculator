...
# 13 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/../mcal_std_libraries.h"
...
Std_ReturnType keypad_initialize(const keypad_t *_keypad_obj){
     ...
     uint8 rows_counter = 0, coloumns_counter = 0;
     ...
     else
     {
         ...
         for(coloumns_counter = 0;coloumns_counter < 4;coloumns_counter++)
         {
...
Std_ReturnType keypad_get_value(const keypad_t *_keypad_obj, uint8 *keypad_value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_rows_counter = 0, l_coloumns_counter = 0, l_counter = 0;
    uint8 column_logic = 0;
     if((((void*)0) == _keypad_obj) || (((void*)0) == keypad_value))
     {
        ret = (Std_ReturnType)0x00 ;
     }
     else
